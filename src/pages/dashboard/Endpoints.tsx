...
const columns = [
  ...
  },
  {
    ...
    render: (item: Endpoint) => (
      <div className="flex items-center gap-2">
        <code className="text-xs bg-secondary px-2 py-1 rounded-md font-mono max-w-[300px] truncate">
          {item.url}
        </code>
  ...
  },
  {
    ...
    header: "Events Today",
    render: (item: Endpoint) => (
      <span className="text-sm tabular-nums">{item.eventsToday.toLocaleString()}</span>
    ),
